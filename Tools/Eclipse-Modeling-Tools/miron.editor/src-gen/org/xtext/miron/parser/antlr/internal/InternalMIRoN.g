...
entryRuleMironModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMironModelRule()); }
	iv_ruleMironModel=ruleMironModel
	{ $current=$iv_ruleMironModel.current; }
	EOF;

// Rule MironModel
ruleMironModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_TimeType_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_NumericSampledType_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_BehaviorTreeEnumType_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_SimpleEnumType_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleNumericSampledType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getNumericSampledTypeRule()); }
	iv_ruleNumericSampledType=ruleNumericSampledType
	{ $current=$iv_ruleNumericSampledType.current; }
	EOF;

// Rule NumericSampledType
ruleNumericSampledType returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSampleValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSampleValueRule()); }
	iv_ruleSampleValue=ruleSampleValue
	{ $current=$iv_ruleSampleValue.current; }
	EOF;

// Rule SampleValue
ruleSampleValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBehaviorTreeEnumType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBehaviorTreeEnumTypeRule()); }
	iv_ruleBehaviorTreeEnumType=ruleBehaviorTreeEnumType
	{ $current=$iv_ruleBehaviorTreeEnumType.current; }
	EOF;

// Rule BehaviorTreeEnumType
ruleBehaviorTreeEnumType returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleBehaviorTreeLiteral returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBehaviorTreeLiteralRule()); }
	iv_ruleBehaviorTreeLiteral=ruleBehaviorTreeLiteral
	{ $current=$iv_ruleBehaviorTreeLiteral.current; }
	EOF;

// Rule BehaviorTreeLiteral
ruleBehaviorTreeLiteral returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleImpactOnQuality returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getImpactOnQualityRule()); }
	iv_ruleImpactOnQuality=ruleImpactOnQuality
	{ $current=$iv_ruleImpactOnQuality.current; }
	EOF;

// Rule ImpactOnQuality
ruleImpactOnQuality returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_VariationPoint_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_BtBinding_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ArchBinding_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleArchBinding returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getArchBindingRule()); }
	iv_ruleArchBinding=ruleArchBinding
	{ $current=$iv_ruleArchBinding.current; }
	EOF;

// Rule ArchBinding
ruleArchBinding returns [EObject current=null]
@init {
	enterRule();
}
@after {
				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getArchBindingAccess().getUnorderedGroup_3(), 0)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getArchBindingAccess().getUnorderedGroup_3(), 0);
								...
								({true}?=>(otherlv_4='parameterSetRepository'
								{
...
entryRuleBtBinding returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBtBindingRule()); }
	iv_ruleBtBinding=ruleBtBinding
	{ $current=$iv_ruleBtBinding.current; }
	EOF;

// Rule BtBinding
ruleBtBinding returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSimpleEnumType returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSimpleEnumTypeRule()); }
	iv_ruleSimpleEnumType=ruleSimpleEnumType
	{ $current=$iv_ruleSimpleEnumType.current; }
	EOF;

// Rule SimpleEnumType
ruleSimpleEnumType returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSimpleEnumLiteral returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSimpleEnumLiteralRule()); }
	iv_ruleSimpleEnumLiteral=ruleSimpleEnumLiteral
	{ $current=$iv_ruleSimpleEnumLiteral.current; }
	EOF;

// Rule SimpleEnumLiteral
ruleSimpleEnumLiteral returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_Precision_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRulePrecision returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPrecisionRule()); }
	iv_rulePrecision=rulePrecision
	{ $current=$iv_rulePrecision.current; }
	EOF;

// Rule Precision
rulePrecision returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCompactLowerBound returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCompactLowerBoundRule()); }
	iv_ruleCompactLowerBound=ruleCompactLowerBound
	{ $current=$iv_ruleCompactLowerBound.current; }
	EOF;

// Rule CompactLowerBound
ruleCompactLowerBound returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCompactUpperBound returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCompactUpperBoundRule()); }
	iv_ruleCompactUpperBound=ruleCompactUpperBound
	{ $current=$iv_ruleCompactUpperBound.current; }
	EOF;

// Rule CompactUpperBound
ruleCompactUpperBound returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCompactPrecision returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCompactPrecisionRule()); }
	iv_ruleCompactPrecision=ruleCompactPrecision
	{ $current=$iv_ruleCompactPrecision.current; }
	EOF;

// Rule CompactPrecision
ruleCompactPrecision returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
ruleImpactIntensityEnum returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
...
ruleInsertionTypeEnum returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
