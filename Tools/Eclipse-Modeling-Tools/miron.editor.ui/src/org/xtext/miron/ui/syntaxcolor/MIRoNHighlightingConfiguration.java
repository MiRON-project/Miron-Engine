 ...
 * (see <code>MIRoNAntlrTokenToAttributeIdMapper</code>). This class needs to be bound in 
 * <code>RootUiModule</code>. 
 * 
 *
 */
public class MIRoNHighlightingConfiguration implements IHighlightingConfiguration {
