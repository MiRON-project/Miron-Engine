 ...
 * </p>
 * <ul>
 *   <li>{@link behaviortree.impl.ControlNodeImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ControlNodeImpl extends TreeNodeImpl implements ControlNode {
	...
	protected EClass eStaticClass() {
		return BehaviorTreePackage.Literals.CONTROL_NODE;
	}
	...
	public EList<TreeNode> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<TreeNode>(TreeNode.class, this, BehaviorTreePackage.CONTROL_NODE__NODES);
		}
		return nodes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BehaviorTreePackage.CONTROL_NODE__NODES:
